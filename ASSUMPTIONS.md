...
> RMSE **$3.77** (paper's original $4.50 / $7.72). Progression: per-type LSQ
> $4.38/$7.54 → unified LSQ → unified SABR → SABR w/o CV $1.93/$4.46 → per-quote-date moneyness filter $1.89/$3.74 → no IV clamp on SABR/SVI $1.93/$3.77.
